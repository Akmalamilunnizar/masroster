...
@section('search')
    <div class="col-md-4">
        <div class="position-relative search-box-wrapper">
            <i class="bx bx-search position-absolute top-50 start-0 translate-middle-y ms-3 text-muted fs-5"
                style="z-index: 5;"></i>
...
@section('content')
    <style>
        @media (min-width: 768px) {
            ...
            .card.main-table-card .table-responsive {
                flex-grow: 1;
            }
        }
    </style>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card shadow-sm border-0 main-table-card" style="border-radius: 15px; overflow: hidden;">
            <div class="card-header d-flex justify-content-between align-items-center"
                style="background: linear-gradient(135deg, #696cff 0%, #4338ca 100%);">
                        ...
                        @forelse($motifs as $m)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('deletemotif', $m->IdMotif) }}" method="POST"
                                        style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger"
                                            onclick="return confirm('Hapus motif ini?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="text-center">Belum ada motif</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
